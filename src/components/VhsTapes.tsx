...
const TAPES: Tape[] = [
  ...
  },
  {
    ...
    genre: "Drama",
    runtime: "128 min",
    note: "O Captain, my Captain. Still gutted every time.",
    spineColor: "#2c4a3b",
    labelColor: "#f0ead6",
    accent: "#c4a35a",
    rotate: 3,
  },
  {
    ...
    genre: "Drama",
    runtime: "126 min",
    note: "It's not your fault. Robin owns every frame.",
    spineColor: "#1e3a5f",
    labelColor: "#e8e0d0",
    accent: "#7eb8da",
    rotate: -1,
  },
  {
    ...
    runtime: "105 min",
    note: "Remember me. Cried so hard I had to pause.",
    spineColor: "#8B3A1E",
    labelColor: "#fff5e0",
    accent: "#ff7f50",
    rotate: 2,
  },
  {
    ...
    genre: "Comedy / Drama",
    runtime: "108 min",
    note: "Taika somehow made Hitler funny. Heartbreaking end.",
    spineColor: "#5a4a3a",
    labelColor: "#f5f0e8",
    accent: "#d4a574",
    rotate: -3,
  },
  {
    ...
    genre: "Animation / Musical",
    runtime: "77 min",
    note: "The piano duet scene lives in my head rent-free.",
    spineColor: "#3a2e4a",
    labelColor: "#e0d8f0",
    accent: "#b8a0d8",
    rotate: 1,
  },
  {
    ...
    runtime: "267 min",
    note: "Layered like an onion. First two are perfect.",
    spineColor: "#4a6b2a",
    labelColor: "#f0f5d8",
    accent: "#9acd32",
    rotate: -2,
  },
  {
    ...
    genre: "Animation / Adventure",
    runtime: "83 min",
    note: "No dialogue needed. The animation still holds up.",
    spineColor: "#8B6914",
    labelColor: "#fdf5d8",
    accent: "#daa520",
    rotate: 2,
  },
  {
    ...
    genre: "Horror / Comedy",
    runtime: "95 min",
    note: "Hide and seek gone very wrong. Samara rules.",
    spineColor: "#6b1e1e",
    labelColor: "#f5e0e0",
    accent: "#ff4444",
    rotate: -1,
  },
  {
    ...
    runtime: "108 min",
    note: "Carrey at his peak weird. The sets were insane.",
    spineColor: "#2a2a4a",
    labelColor: "#e8e0f0",
    accent: "#a080d0",
    rotate: 3,
  },
  {
    ...
    runtime: "125 min",
    note: "The wait was worth it. Every frame is art.",
    spineColor: "#8B4513",
    labelColor: "#fff8e8",
    accent: "#ff8c00",
    rotate: -3,
